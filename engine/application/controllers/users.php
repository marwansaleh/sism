...
class Users extends MY_AdminController {
    ...
    function save(){
        ...
        if ($this->form_validation->run() != FALSE) {
            $postdata = $this->user_m->array_from_post(array('full_name','sex','group_id','type','jabatan','pangkat','golongan','nip','username','password','change_password','email','mobile','phone','avatar','about'));
