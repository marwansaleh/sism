!function($, wysi) {
    ...
    var tpl = {
        ...
        "horizontal_line": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "" +
                "<li class='wysihtml5-toolbar-horizontalline'>" +
                    "<a class='btn " + size + " btn-default' data-wysihtml5-command='insertHTML' data-wysihtml5-command-value='<hr>' title='" + locale.text.horizontal_line + "' tabindex='-1'><i style='font-weight:bold;'>hr</i></a>" +
                "</li>";
        },
        ...
        "html": function(locale, options) {
            ...
            return "" +
                "<li>" +
                    "<button type='button' class='btn " + size + " btn-info' data-wysihtml5-action='change_view' title='" + locale.html.edit + "' tabindex='-1'><b style='letter-spacing:1px;'>&lt;/&gt;</b></button>" +
                "</li>";
        }
    };
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        parserRules: {
            classes: {
                ...
                "img-responsive": 1,
                "mail-header-logo": 1,
                "mail-header-detail": 1,
                "mail-header-title": 1,
                "mail-footer-sign-container": 1
            },
            /*type_definitions: {
